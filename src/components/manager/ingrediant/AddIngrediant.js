...
const AddIngrediant = ({}) => {
  ...
  const handleCreateCategory = async () => {
    ...
    const reponse = await fetch(
      "http://localhost:5000/api/ingrediant/add",
      requestOptions
    );
    const data = await reponse.json();
    if (reponse.status === 200) {
      swal({
        title: "Ingrediant was register successfully!",
        text: "",
        icon: "success",
        button: "Ok",
      });
  ...
  return (
    <div className="p-8 relative container-add-recette">
      ...
      <h1 className="text-2xl font-black">Ajouter une nouveaux Ingrediant</h1>
      <div className="w-full mt-5 flex gap-6">
        ...
        <div className="w-1/4">
          <div className="fixed top-10 right-10">
            <h3 className="text-2xl  font-bold mb-3">Ingrediant preview</h3>
